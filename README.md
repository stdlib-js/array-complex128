...
```javascript
Complex128Array = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-complex128@v0.3.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-complex128@v0.3.1-umd/browser.js"></script>
```
