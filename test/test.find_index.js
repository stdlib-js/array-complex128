...
tape( 'attached to the prototype of the main export is a `findIndex` method', function test( t ) {
	t.strictEqual( hasOwnProp( Complex128Array.prototype, 'findIndex' ), true, 'has property' );
	t.strictEqual( isFunction( Complex128Array.prototype.findIndex ), true, 'has method' );
	t.end();
});
